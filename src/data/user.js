const INFO = {
	...
	projects: [
...

		{
			title: "Gitlet 🕹️",
			description:
				"A minimalistic version control system that implements the core functionalities of Git.",
			logo: "https://cdn.jsdelivr.net/npm/programming-languages-logos/src/java/java.png",
			linkText: "View Project",
			link: "https://github.com/jessie-sr/gitlet",
		},
		
		{
			title: "Random World 🗺️",
			description:
				"A 2D tile-based world exploration game engine that features pseudorandomly generated rooms and hallways.",
			logo: "https://cdn.jsdelivr.net/npm/programming-languages-logos/src/java/java.png",
			linkText: "View Project",
			link: "https://github.com/jessie-sr/random-world",
		},
